...
public class FuncionariosInserirCargo extends JFrame {
	...
	public FuncionariosInserirCargo(Funcionario novoFuncionario) {
		this.novoFuncionario = novoFuncionario;
		novoFuncionario.setFuncionarioCargo("");
		criarComponentes();
		criarEventos();
	}
	...
	public void criarEventos() {
		...
		comboBoxInserirCargo.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if (e.getStateChange() == ItemEvent.SELECTED) {
					...
					novoFuncionario.setFuncionarioCargo(cargoSelecionado);
				}
			}
		});
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				if (novoFuncionario.getFuncionarioCargo().length() == 0) {
	...
	public void voltaFrame() {
		Navegador.funInserirCargo.setVisible(false);
	}
